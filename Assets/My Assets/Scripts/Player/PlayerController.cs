...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        myWeapons[0] = new WeaponClass(1f, 10f, 0f, 1, 1, bullet1, gunBarrel, shotDirection, shotPower, "light"); //RateofFire,PressureCost,Damage,base damage, damage mod, prefab,GunBarrel,ShotDirection,ShotPower
        myWeapons[1] = new WeaponClass(1.5f, 20f, 0f, 1, 2, bullet2, gunBarrel, shotDirection, shotPower, "medium");
        myWeapons[2] = new WeaponClass(2f, 30f, 0f, 1, 3, bullet3, gunBarrel, shotDirection, shotPower, "heavy");
